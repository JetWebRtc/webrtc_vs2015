...
public:
    ...
    void set_signaling_delay_ms(int delay_ms)
    {
        signaling_delay_ms_ = delay_ms;
    }
    ...
    bool ExpectIceRestart() const
    {
        return expect_ice_restart_;
    }
    ...
    bool ExpectIceRenomination()
    {
        return expect_ice_renomination_;
    }
    bool ExpectRemoteIceRenomination()
    {
        return expect_remote_ice_renomination_;
    }
    ...
    void RemoveCvoFromReceivedSdp(bool remove)
    {
        remove_cvo_ = remove;
    }
    ...
    {
        return StreamsHaveAudioTrack(local_streams());
    }

    bool HasLocalVideoTrack()
    {
        return StreamsHaveVideoTrack(local_streams());
    }
...
public:
    ...
    {
        return CreateTestClients(nullptr, nullptr);
    }
