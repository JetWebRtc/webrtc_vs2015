...
int32_t AudioDeviceDummy::SetAGC(bool enable)
{
    return -1;
}
...
int32_t AudioDeviceDummy::SetMicrophoneBoost(bool enable)
{
    return -1;
}

int32_t AudioDeviceDummy::MicrophoneBoost(bool& enabled) const
{
    return -1;
}
...
int32_t AudioDeviceDummy::RecordingDelay(uint16_t& delayMS) const
{
    return -1;
}

int32_t AudioDeviceDummy::CPULoad(uint16_t& load) const
{
    return -1;
}
