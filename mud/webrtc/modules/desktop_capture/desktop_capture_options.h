...
public:
...
#if defined(USE_X11)
    SharedXDisplay* x_display() const
    {
        return x_display_;
    }
    ...
    bool use_update_notifications() const
    {
        return use_update_notifications_;
    }
    ...
    bool detect_updated_region() const
    {
        return detect_updated_region_;
    }
