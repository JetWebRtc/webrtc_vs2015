...
static int config_output(AVFilterLink *outlink)
{
    ...
    outlink->frame_rate = av_div_q((AVRational)
    {
        inlink->sample_rate,showwaves->n
    },
    (AVRational)
    {
        showwaves->w,1
...
static av_cold int init(AVFilterContext *ctx)
{
    ...
    {
    case MODE_POINT:
        showwaves->draw_sample = draw_sample_point;
        break;
    case MODE_LINE:
        showwaves->draw_sample = draw_sample_line;
        break;
    case MODE_P2P:
        showwaves->draw_sample = draw_sample_p2p;
        break;
    case MODE_CENTERED_LINE:
        showwaves->draw_sample = draw_sample_cline;
        break;
    default:
        return AVERROR_BUG;
    }
