...
static int decode_slice_header(FFV1Context *f, FFV1Context *fs)
{
                           ...
                           f->cur->sample_aspect_ratio) < 0)
    {
        ...
        f->cur->sample_aspect_ratio = (AVRational)
        {
            0, 1
        };
    }
...
static int read_header(FFV1Context *f)
{
    ...
    if (f->colorspace == 0)
    {
        ...
        else if (f->avctx->bits_per_raw_sample == 9 && f->transparency)
        {
            ...
            {
            case 0x00:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA444P9;
                break;
            case 0x10:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA422P9;
                break;
            case 0x11:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA420P9;
                break;
            }
        }
        ...
        else if (f->avctx->bits_per_raw_sample == 10 && f->transparency)
        {
            ...
            {
            case 0x00:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA444P10;
                break;
            case 0x10:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA422P10;
                break;
            case 0x11:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA420P10;
                break;
            }
        }
        ...
        else if (f->avctx->bits_per_raw_sample == 16 && f->transparency)
        {
            ...
            {
            case 0x00:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA444P16;
                break;
            case 0x10:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA422P16;
                break;
            case 0x11:
                f->avctx->pix_fmt = AV_PIX_FMT_YUVA420P16;
                break;
            }
        }
    }
    else if (f->colorspace == 1)
    {
        ...
        else if (f->transparency) f->avctx->pix_fmt = AV_PIX_FMT_RGB32;
