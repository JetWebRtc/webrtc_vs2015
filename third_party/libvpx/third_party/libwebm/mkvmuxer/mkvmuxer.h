...
public:
    ...
    void set_track_number(uint64_t track_number)
    {
...
public:
    ...
    void set_cluster_pos(uint64_t cluster_pos)
    {
...
public:
    ...
    int32_t cue_entries_size() const
    {
...
public:
    ...
    uint64_t enc_algo() const
    {
        return enc_algo_;
    }
    uint64_t encoding_order() const
    {
        return encoding_order_;
    }
    uint64_t encoding_scope() const
    {
        return encoding_scope_;
    }
    uint64_t encoding_type() const
    {
...
public:
    ...
    const PrimaryChromaticity* r() const
    {
        return r_;
    }
    const PrimaryChromaticity* g() const
    {
        return g_;
    }
    const PrimaryChromaticity* b() const
    {
        return b_;
    }
    const PrimaryChromaticity* white_point() const
    {
        return white_point_;
    }
...
public:
    ...
    uint64_t matrix_coefficients() const
    {
    ...
    uint64_t bits_per_channel() const
    {
    ...
    uint64_t chroma_siting_vert() const
    {
...
public:
    ...
    void set_pose_yaw(float pose_yaw)
    {
        pose_yaw_ = pose_yaw;
    }
    float pose_pitch() const
    {
        return pose_pitch_;
    }
    void set_pose_pitch(float pose_pitch)
    {
        pose_pitch_ = pose_pitch;
    }
    float pose_roll() const
    {
        return pose_roll_;
    }
    void set_pose_roll(float pose_roll)
    {
        pose_roll_ = pose_roll;
    }
    uint8_t* private_data() const
    {
        return private_data_;
    }
    uint64_t private_data_length() const
    {
        return private_data_length_;
    }
...
public:
    ...
    const uint8_t* codec_private() const
    {
    ...
    uint64_t max_block_additional_id() const
    {
    ...
    uint64_t codec_private_length() const
    {
...
public:
    ...
    void set_display_height(uint64_t height)
    {
        display_height_ = height;
    }
    uint64_t display_height() const
    {
        return display_height_;
    }
    void set_display_width(uint64_t width)
    {
        display_width_ = width;
    }
    uint64_t display_width() const
    {
        return display_width_;
    }
    void set_pixel_height(uint64_t height)
    {
    ...
    void set_pixel_width(uint64_t width)
    {
        pixel_width_ = width;
    }
    ...
    void set_crop_left(uint64_t crop_left)
    {
        crop_left_ = crop_left;
    }
    uint64_t crop_left() const
    {
        return crop_left_;
    }
    void set_crop_right(uint64_t crop_right)
    {
        crop_right_ = crop_right;
    }
    uint64_t crop_right() const
    {
        return crop_right_;
    }
    void set_crop_top(uint64_t crop_top)
    {
        crop_top_ = crop_top;
    }
    uint64_t crop_top() const
    {
        return crop_top_;
    }
    void set_crop_bottom(uint64_t crop_bottom)
    {
        crop_bottom_ = crop_bottom;
    }
    uint64_t crop_bottom() const
    {
        return crop_bottom_;
    }
...
public:
    ...
    uint32_t track_entries_size() const
    {
...
public:
    ...
    int64_t size_position() const
    {
        return size_position_;
    }
    int32_t blocks_added() const
    {
    ...
    int64_t position_for_cues() const
    {
...
public:
    ...
    void set_date_utc(int64_t date_utc)
    {
        date_utc_ = date_utc;
    }
    int64_t date_utc() const
    {
        return date_utc_;
    }
...
public:
    ...
    uint64_t max_cluster_duration() const
    {
    ...
    uint64_t max_cluster_size() const
    {
    ...
    bool estimate_file_duration() const
    {
        return estimate_file_duration_;
    }
