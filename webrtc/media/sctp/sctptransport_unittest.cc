...
public:
    ...
    ReceiveDataParams last_params() const
    {
        return last_params_;
    }
...
protected:
    ...
    {
        return transport1_.get();
    }
    SctpTransport* transport2()
    {
        return transport2_.get();
    }
    ...
    {
        return fake_dtls1_.get();
    }
    FakeDtlsTransport* fake_dtls2()
    {
        return fake_dtls2_.get();
    }
...
private:
    ...
    void OnChan1ReadyToSend()
    {
        ++transport1_ready_to_send_count_;
    }
    void OnChan2ReadyToSend()
    {
