...
public:
    ...
    {
        max_parent_size_ = size;
    }
    void set_min_parent_size(int size)
    {
        min_parent_size_ = size;
    }
    PartitionTreeNode* parent() const
    {
        return parent_;
    }
    PartitionTreeNode* left_child() const
    {
        return children_[kLeftChild];
    }
    PartitionTreeNode* right_child() const
    {
        return children_[kRightChild];
    }
...
private:
    ...
    int this_size_int() const
    {
        return static_cast<int>(this_size_);
    }
    void set_packet_start(bool value)
    {
        packet_start_ = value;
    }
