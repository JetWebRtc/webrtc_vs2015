...
public:
    ...
    uint32_t estimated_bps() const
    {
        return estimated_bps_;
    }
    RTCPReportBlock report_block() const
    {
...
public:
    ...
    const std::vector<uint16_t>& acked_packets() const
    {
