...
public:
    ...
    {
        audio_sender_destroyed_signal_fired_ = true;
    }

    void CreateVideoRtpSender()
    {
        CreateVideoRtpSender(false);
    }
    ...
    {
        VerifyVoiceChannelInput(kAudioSsrc);
    }
    ...
    {
        VerifyVideoChannelInput(kVideoSsrc);
    }
