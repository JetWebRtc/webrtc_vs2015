...
struct MediaSessionOptions
{
    ...
    bool has_data() const
    {
        return data_channel_type != DCT_NONE;
    }
...
public:
    ...
    const DataCodecs& data_codecs() const
    {
        return data_codecs_;
    }
