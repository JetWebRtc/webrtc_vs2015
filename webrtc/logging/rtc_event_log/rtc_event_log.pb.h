...
public:
    ...
    inline AudioPlayoutEvent* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline BwePacketLossEvent* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline VideoReceiveConfig* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline DecoderConfig* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline RtpHeaderExtension* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline VideoSendConfig* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline EncoderConfig* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline AudioReceiveConfig* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline AudioSendConfig* New() const
    {
        return New(NULL);
    }
...
public:
    ...
    inline AudioNetworkAdaptation* New() const
    {
        return New(NULL);
    }
