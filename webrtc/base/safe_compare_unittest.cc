...
{
    return static_cast<unsigned>(a) < 17u;
}
...
{
    return safe_cmp::Lt(a, uintmax_t{17});
}
bool TestLessThanMax17( uintmax_t a)
{
    return safe_cmp::Lt(a,  intmax_t{17});
}
